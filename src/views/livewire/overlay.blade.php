    ...
    <div wire:click='close'
        ...
        <div
            ...
            <div class="flex justify-center items-center flex-col m-3">
                ...
                <p class="text-sm text-gray-600 dark:text-gray-200 mt-3">
                    <?= $builder->message() ?>
                </p>
            </div>

            <button type="button" wire:click='close'
                class="flex capitalize justify-center items-center font-semibold cursor-pointer <?= $builder->bgColor() ?> px-10 py-1.5 rounded-lg text-sm">
